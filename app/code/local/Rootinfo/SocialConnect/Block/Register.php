...
class Rootinfo_SocialConnect_Block_Register extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->clientGoogle = Mage::getSingleton('rootinfo_socialconnect/google_client');
        $this->clientFacebook = Mage::getSingleton('rootinfo_socialconnect/facebook_client');
        $this->clientTwitter = Mage::getSingleton('rootinfo_socialconnect/twitter_client');
        ...
        Mage::register('rootinfo_socialconnect_button_text', $this->__('Register'));

        $this->setTemplate('rootinfo/socialconnect/register.phtml');
    }
