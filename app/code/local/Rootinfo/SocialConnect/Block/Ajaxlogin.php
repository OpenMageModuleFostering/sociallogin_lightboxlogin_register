...
/**
 * Block class for ajaxlogin view section.
 * Class Rootinfo_Ajaxlogin_Block_Ajaxlogin
 * @author Root Info Solution Pvt Ltd.
 */

class Rootinfo_SocialConnect_Block_Ajaxlogin extends Mage_Core_Block_Template
{
    /**
    ...
    {
        if (Mage::getStoreConfig('rootinfoajaxlogin/settings/redirection')) {
            return '1';
        }
