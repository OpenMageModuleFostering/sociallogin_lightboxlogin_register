...
class Rootinfo_SocialConnect_Block_Facebook_Account extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->setTemplate('rootinfo/socialconnect/facebook/account.phtml');
    }
    ...
    protected function _getPicture()
    {
        if(!empty($this->userInfo->picture)) {
            return Mage::helper('rootinfo_socialconnect/facebook')
