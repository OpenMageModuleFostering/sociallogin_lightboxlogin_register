...
class Rootinfo_SocialConnect_Block_Login extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('rootinfo_socialconnect_button_text', $this->__('Login'));

        $this->setTemplate('rootinfo/socialconnect/login.phtml');
    }
