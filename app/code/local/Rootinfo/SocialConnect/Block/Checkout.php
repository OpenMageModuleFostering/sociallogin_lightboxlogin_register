...
class Rootinfo_SocialConnect_Block_Checkout extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('rootinfo_socialconnect_button_text', $this->__('Continue'));

        $this->setTemplate('rootinfo/socialconnect/checkout.phtml');
    }
