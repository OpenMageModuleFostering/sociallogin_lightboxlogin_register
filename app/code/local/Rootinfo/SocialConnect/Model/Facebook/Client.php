...
class Rootinfo_SocialConnect_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'socialconnect/facebook/connect';

    const XML_PATH_ENABLED = 'rootinfoajaxlogin/rootinfo_socialconnect_facebook/enabled';
    const XML_PATH_CLIENT_ID = 'rootinfoajaxlogin/rootinfo_socialconnect_facebook/client_id';
    const XML_PATH_CLIENT_SECRET = 'rootinfoajaxlogin/rootinfo_socialconnect_facebook/client_secret';
    ...
    protected function fetchAccessToken()
    {
        if(empty($_REQUEST['code'])) {
            throw new Exception(
                Mage::helper('rootinfo_socialconnect')
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                if(isset($decoded_response->error->message)) {
                    ...
                    $message = Mage::helper('rootinfo_socialconnect')
...
class Rootinfo_SocialConnect_FacebookOAuthException extends Exception
{}