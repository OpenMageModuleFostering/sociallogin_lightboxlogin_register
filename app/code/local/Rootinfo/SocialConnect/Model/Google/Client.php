...
class Rootinfo_SocialConnect_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'socialconnect/google/connect';

    const XML_PATH_ENABLED = 'rootinfoajaxlogin/rootinfo_socialconnect_google/enabled';
    const XML_PATH_CLIENT_ID = 'rootinfoajaxlogin/rootinfo_socialconnect_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'rootinfoajaxlogin/rootinfo_socialconnect_google/client_secret';
...
class Rootinfo_SocialConnect_GoogleOAuthException extends Exception
{}
