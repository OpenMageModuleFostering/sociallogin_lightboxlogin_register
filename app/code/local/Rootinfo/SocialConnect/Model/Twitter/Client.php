...
class Rootinfo_SocialConnect_Model_Twitter_Client
{
    ...
    const XML_PATH_ENABLED = 'rootinfoajaxlogin/rootinfo_socialconnect_twitter/enabled';
    const XML_PATH_CLIENT_ID = 'rootinfoajaxlogin/rootinfo_socialconnect_twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'rootinfoajaxlogin/rootinfo_socialconnect_twitter/client_secret';
...
class Rootinfo_SocialConnect_TwitterOAuthException extends Exception
{}
