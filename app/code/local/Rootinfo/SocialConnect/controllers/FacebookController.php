...
class Rootinfo_SocialConnect_FacebookController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('rootinfo_socialconnect/facebook')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $customersByFacebookId = Mage::helper('rootinfo_socialconnect/facebook')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('rootinfo_socialconnect/facebook')->connectByFacebookId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByFacebookId->count()) {
                ...
                Mage::helper('rootinfo_socialconnect/facebook')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('rootinfo_socialconnect/facebook')
            ...
            Mage::helper('rootinfo_socialconnect/facebook')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->first_name,
                $userInfo->last_name,
                $userInfo->id,
