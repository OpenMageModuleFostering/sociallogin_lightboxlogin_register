...
class Rootinfo_SocialConnect_GoogleController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('rootinfo_socialconnect/google')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $customersByGoogleId = Mage::helper('rootinfo_socialconnect/google')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('rootinfo_socialconnect/google')->connectByGoogleId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByGoogleId->count()) {
                ...
                Mage::helper('rootinfo_socialconnect/google')->loginByCustomer($customer);
            ...
            Mage::helper('rootinfo_socialconnect/google')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->given_name,
